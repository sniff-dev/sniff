...
| `system_prompt` | `string` | ✓        | Length: 1-10000                           |
| `model`         | `object` | ✓        | -                                         |
...
### agent.model.anthropic.thinking
...
### agent.model.anthropic.metadata

| Field     | Type     | Required | Constraints     |
| --------- | -------- | -------- | --------------- |
| `user_id` | `string` |          | Max length: 256 |

### agent.model.anthropic.tool_choice
...
### agent.model.anthropic.tools[].user_location
...
| `blocked_domains`    | string[]               |          | -           |
| `citations`          | `object`               |          | -           |
| `max_content_tokens` | `integer`              |          | ≥ 1         |

### agent.model.anthropic.tools[].citations

| Field     | Type      | Required |
| --------- | --------- | -------- |
| `enabled` | `boolean` | ✓        |

### agent.model.anthropic.mcp_servers[]
...
### agent.model.anthropic.mcp_servers[].tool_configuration
